...
/** Lo que devuelve GET /characters/:id (Character.toSnapshot, sin id: el id ya lo tiene quien pregunta). */
export interface CharacterSnapshot {
  ...
  /** Escudo equipado (+2 CA, se suma a la armadura). */
...
export interface GameSnapshot {
  ...
  /**
   * true mientras el DM-IA responde a un turno (de cualquier jugador). La API
   * rechaza una segunda acción hasta que termine, así que el móvil bloquea
   * sus botones mientras tanto.
   */
