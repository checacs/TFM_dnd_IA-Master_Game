...
// MONGODB_URI es la variable documentada (.env.example, README); URL se mantiene
// como alias por compatibilidad con despliegues que ya la usan (Render). Con ||
// y no ??: un "MONGODB_URI=" vacío (como venía en .env.example) cae a URL.
