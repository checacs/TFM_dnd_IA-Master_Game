...
import { ResolveEnemyAttackUseCase } from '../application/use-cases/resolve-enemy-attack.use-case';
...
@Module({
  ...
  providers: [
    ...
    GrantCurrencyUseCase,
    BuyItemUseCase,
    PlayerRollUseCase,
    StartOpeningSceneUseCase,
    GameMcpTools,
    { provide: DM_ENGINE_CLIENT, useFactory: () => new HttpDmEngineClient(DM_ENGINE_URL as string, process.env.INTERNAL_API_KEY) },
