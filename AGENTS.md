...
- `ui-web/` — React 18 + TypeScript + Vite + TanStack Query + React Router (chat + tablero, solo lectura).
- `mobile-app/` — React Native + Expo: ficha de personaje, progresión y única superficie de juego (paso 8).
...
- UI web: React 18 + TypeScript + Vite + TanStack Query + React Router
